...
# Normalizasyon öncesi ham veri grafiği
...
with open('C:/Users/User/Desktop/ML_Proje/b/min_max_regresyon_results.txt', 'w') as f:
    f.write(results)

# Normalizasyon sonrası veri grafiği
plt.figure(figsize=(10, 6))
...
plt.ylabel('Sonuç')
plt.legend()
plt.title('Normalizasyon Sonrası Logistic Regression')
plt.savefig('C:/Users/User/Desktop/ML_Proje/b/min_max_regresyon_image.png')
plt.close()
...
plt.savefig('C:/Users/User/Desktop/ML_Proje/b/min_max_regresyon_conf_matrix.png')
plt.close()
