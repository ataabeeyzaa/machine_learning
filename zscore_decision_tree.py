...
with open('C:\\Users\\User\\Desktop\\ML_Proje\\b\\tree_fare_metrics.txt', 'w', encoding='utf-8') as f:
    f.write(metrics)
...
plt.savefig('C:\\Users\\User\\Desktop\\ML_Proje\\b\\tree_fare_conf_matrix.png')
plt.close()
