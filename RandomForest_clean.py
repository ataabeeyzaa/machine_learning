...
# 7. Random Forest Modeli Eğitimi
...
# Metrikleri kaydet
metrics = f'Random Forest:\nAccuracy: {accuracy}\nPrecision: {precision}\nRecall: {recall}\nF1 Score: {f1}\n'
with open('C:\\Users\\User\\Desktop\\ML_Proje\\b\\random_forest_metrics.txt', 'w', encoding='utf-8') as f:
    f.write(metrics)
...
plt.ylabel('Gerçek')
plt.title('Random Forest Karışıklık Matrisi')
plt.savefig('C:\\Users\\User\\Desktop\\ML_Proje\\b\\random_forest_conf_matrix.png')
plt.close()
