...
# Metrikleri kaydet
metrics = f'logistic_regression:\nAccuracy: {accuracy}\nPrecision: {precision}\nRecall: {recall}\nF1 Score: {f1}\nROC AUC Score: {roc_auc}'
with open('C:\\Users\\User\\Desktop\\ML_Proje\\b\\logreg_fare_metrics.txt', 'w', encoding='utf-8') as f:
    f.write(metrics)
...
plt.savefig('C:\\Users\\User\\Desktop\\ML_Proje\\b\\logreg_fare_conf_matrix.png')
plt.close()
