...
# Metrikleri kaydet
metrics = f'Logistic Regression:\nAccuracy: {accuracy}\nPrecision: {precision}\nRecall: {recall}\nF1 Score: {f1}\n'
with open('C:\\Users\\User\\Desktop\\ML_Proje\\b\\logistic_regression_metrics.txt', 'w', encoding='utf-8') as f:
    f.write(metrics)
...
plt.ylabel('Gerçek')
plt.title('Lojistik Regresyon Karışıklık Matrisi')
plt.savefig('C:\\Users\\User\\Desktop\\ML_Proje\\b\\logistic_regression_conf_matrix.png')
plt.close()
