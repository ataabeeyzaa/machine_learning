...
with open('C:/Users/User/Desktop/ML_Proje/b/zscore_karar_agaci_results.txt', 'w') as f:
    f.write(results)
...
plt.ylabel('Sonuç')
plt.legend()
plt.savefig('C:/Users/User/Desktop/ML_Proje/b/zscore_karar_agaci_image.png')
plt.close()
