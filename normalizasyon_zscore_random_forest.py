...
with open('C:/Users/User/Desktop/ML_Proje/b/zscore_random_forest_results.txt', 'w') as f:
    f.write(results)
...
plt.ylabel('Sonuç')
plt.legend()
plt.savefig('C:/Users/User/Desktop/ML_Proje/b/zscore_random_forest_image.png')
plt.close()
