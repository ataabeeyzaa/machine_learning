...
# Metrikleri kaydet
metrics = f'Decision Tree:\nAccuracy: {accuracy}\nPrecision: {precision}\nRecall: {recall}\nF1 Score: {f1}\n'
with open('C:\\Users\\User\\Desktop\\ML_Proje\\b\\decision_tree_metrics.txt', 'w', encoding='utf-8') as f:
    f.write(metrics)
...
plt.ylabel('Gerçek')
plt.title('Karar Ağacı Karışıklık Matrisi')
plt.savefig('C:\\Users\\User\\Desktop\\ML_Proje\\b\\decision_tree_conf_matrix.png')
plt.close()
