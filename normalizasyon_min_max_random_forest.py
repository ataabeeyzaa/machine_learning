...
# Random Forest modelini eğitin ve değerlendirin
...
with open('C:/Users/User/Desktop/ML_Proje/b/min_max_random_forest_results.txt', 'w') as f:
    f.write(results)
...
plt.ylabel('Sonuç')
plt.legend()
plt.savefig('C:/Users/User/Desktop/ML_Proje/b/min_max_random_forest_image.png')
plt.close()
